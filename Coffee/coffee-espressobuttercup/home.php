...
<body>
   ...
   <section class="home">
      ...
      <div class="content">
         <h3>Espresso ButterCup</h3>
         <p>Welcome to Espresso ButterCup! Enjoy our freshly brewed coffee and homemade treats in a cozy atmosphere. Perfect for a quick espresso or a leisurely catch-up with friends. Great coffee, great company.</p>
   ...
   <section class="products">
      ...
      <h1 class="title">Popular Menus</h1>
