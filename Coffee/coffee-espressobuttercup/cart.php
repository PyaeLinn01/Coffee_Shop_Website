...
if (isset($_GET['delete'])) {
    ...
    $cart_item = mysqli_fetch_assoc($fetch_cart);
...
<section class="shopping-cart">
    ...
    <div class="box">
        ...
        <div class="quantity">Quantity: <?php echo $fetch_cart['quantity']; ?></div>
    ...
    <div class="more-btn">
        <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>" onclick="return confirm('remove all from cart?');">remove all</a>
    </div>
