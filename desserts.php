...
<section class="products">
    ...
    <div class="box-container">
        ...
        <?php
        // Fetch the category ID for 'Desserts'
        $category_query = mysqli_query($conn, "SELECT id FROM `categories` WHERE name = 'Desserts'") or die('query failed');
        $category_data = mysqli_fetch_assoc($category_query);
        $category_id = $category_data['id'];

        // Fetch products from the 'Desserts' category
